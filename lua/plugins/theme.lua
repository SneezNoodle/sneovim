	...
	},
	{
		...
		config = function()
			...
			local components = {
				filename = {
					...
					fmt = function(str, ctx)
						if vim.o.ft == "oil" then return require("oil").get_current_dir()
						else return str end
					end
				},
				-- Display cwd with an icon
				cwd = function() return " " .. vim.fn.fnamemodify(vim.fn.getcwd(), ":~") end,
			}
			require("lualine").setup {
				...
				tabline = { lualine_a = { "tabs" }, lualine_b = { }, lualine_c = { }, lualine_x = { }, lualine_y = { }, lualine_z = { }, },
